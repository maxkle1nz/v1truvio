...
- **binding:** `trust_mode: "full_trust"`, `ok: true`, `fingerprint`: `binary_version 1.3.2`, `binary_git_sha ef9c6e9`, `node_count 521`, `edge_count 500`, `graph_finalized true`, `runtime_root ~/.m1nd/runtimes/claude`.
...
- **reception:** `match: "caller_root_mismatch"`, `honest: "this graph does NOT cover your repo"`, `bound_workspace: "~/.m1nd/runtimes/claude/agent-memory"`, `caller_root: "~"`, `options[]`: `continue_bound` e `ingest_your_repo` (com as notas reais).
